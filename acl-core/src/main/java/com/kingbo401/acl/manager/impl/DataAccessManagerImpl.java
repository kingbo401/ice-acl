...
import com.kingbo401.acl.dao.DataGrantRecordDetailDAO;
...
public class DataAccessManagerImpl implements DataAccessManager{
	...
	private List<DataGrantRecordDTO> buildDataGrantRecordDTOs(List<DataGrantRecordDO> datas, Long modelId, String modelCode){
