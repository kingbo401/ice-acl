...
public class IceAclConstant {
	 ...
	 * 拥有所有值的标识
	 */
	public static final String GRANTED_ALL_DATA_SYMBOL = "all_data_symbol";
	/**
	 * 如果授权对象不区分租户，使用此常量给授权参数里的租户字段赋值
	 */
	public static final String TENANT_COMMON_SYMBOL = "tenant_common_symbol";
